...
// structure, formula, weight and CAS number from the FDA/NCATS substance
// registry (public domain), and render.mjs draws its structure tile
...
export const TAXONOMY: CatalogueLine[] = [
  ...
  },
  {
    ...
    // most major API categories. The first listings (client's product list,
    // 2026-09-24) added hormones, vitamins and three therapeutic classes; the
    // list filed finasteride, dutasteride, spironolactone and polymyxin B
    // under corticosteroids, which they are not. Groups with no items yet
    // (anticancer, antidepressants) stay out of the filters until they have.
    groups: [
      { id: 'corticosteroids', name: 'Corticosteroids' },
      {
        ...
        name: 'Hormones',
        types: [
          { id: 'progestogens', name: 'Progestogens & Antiprogestogens', short: 'Progestogens' },
          { id: 'androgens', name: 'Androgens & Anabolic Steroids', short: 'Androgens' },
        ],
      },
